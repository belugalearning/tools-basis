...
-(void) directorDidReshapeProjection:(CCDirector*)director
{
	if(director.runningScene == nil) {
        //setup bindings
        [[JSBCore sharedInstance] runScript:BUNDLE_FULL_PATH(@"host-helpers/ios-initbind.js")];
        
        //qlayer
        [[JSBCore sharedInstance] runScript:BUNDLE_FULL_PATH(@"host-helpers/shared-qlayer.js")];
...
//		[[JSBCore sharedInstance] runScript:BUNDLE_FULL_PATH(@"tools-tests/test-support/test-disttool.js")];]
        ...
        //host it on a layer
        [[JSBCore sharedInstance] runScript:BUNDLE_FULL_PATH(@"host-helpers/ios-layerasscene.js")];
	}
}
@end
